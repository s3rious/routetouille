...
function WithChildren<ComposedOptions extends {}, ComposedInterface extends {}>(
  ...
  return (
    options: WithChildrenOptions & ComposedOptions,
  ): WithChildrenInterface & ComposedInterface => {
...
export { WithChildren, type WithChildrenOptions, type WithChildrenInterface };
