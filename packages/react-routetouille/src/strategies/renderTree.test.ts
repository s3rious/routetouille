...
describe('renderTree', () => {
  ...
  it('renders a tree of components for active routes with components', () => {
    const route1 = { component: vi.fn(() => React.createElement('div', null, 'Dummy')) }
    const route2 = { component: vi.fn(() => React.createElement('div', null, 'Dummy')) }
  ...
  it('provides the router in context', () => {
    const route = { component: vi.fn(() => React.createElement('div', null, 'Dummy')) }
