async function makeCall<Data, Result>(
  method: string,
  url: string,
  data: Data,
  result: Result,
...
async function GET<Data, Result>(
  url: string,
  data: Data,
  result: Result,
): Promise<Result> {
...
async function POST<Data, Result>(
  url: string,
  data: Data,
  result: Result,
): Promise<Result> {
...
async function PATCH<Data, Result>(
  url: string,
  data: Data,
  result: Result,
): Promise<Result> {
...
async function DELETE<Data, Result>(
  url: string,
  data: Data,
  result: Result,
): Promise<Result> {
