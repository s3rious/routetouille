function getListOf<AbstractModelInterface extends {}, AbstractModelProps>(
  AbstractModel: new (
    AbstractModelProps: AbstractModelProps,
  ...
  return unknowns
    ...
    .filter(
      (modelOrNull): modelOrNull is AbstractModelInterface =>
        modelOrNull instanceof AbstractModel,
    );
}

// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
function ListOf<AbstractModelInterface extends {}, AbstractModelProps>(
  AbstractModel: new (
    AbstractModelProps: AbstractModelProps,
  ) => AbstractModelInterface,
  process?: (
    AbstractModels: AbstractModelInterface[],
  ) => AbstractModelInterface[],
) {
  return class ListOfModel extends Array<AbstractModelInterface> {
    constructor(...items: AbstractModelProps[]) {
      let AbstractModels = getListOf<
        AbstractModelInterface,
        AbstractModelProps
      >(AbstractModel, items);
